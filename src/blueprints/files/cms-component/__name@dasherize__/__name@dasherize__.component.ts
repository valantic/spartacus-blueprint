...
import { <%= classify(projectName) %>CmsComponent } from '../cms';
...
// TODO remove <%= dasherize(projectName) %>CmsComponent extension, if your component does not need grid / background color functionality
